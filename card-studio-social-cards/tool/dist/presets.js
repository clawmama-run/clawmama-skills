...
exports.classifyAspect = classifyAspect;
/**
...
function getPreset(id) {
    const p = exports.PRESETS.find((x) => x.id === id);
    if (!p)
        throw new Error(`Unknown preset "${id}". Available: ${exports.PRESETS.map((x) => x.id).join(', ')}`);
    return p;
}
